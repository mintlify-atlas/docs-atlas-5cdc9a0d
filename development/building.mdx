...
<CardGroup cols={2}>
  ...
  <Card title="cromite_patches_list.txt" icon="file-lines">
    Lists all 333 patches applied to Chromium
...
Cromite applies 333 patches to Chromium. These patches must be applied in the order specified in `cromite_patches_list.txt`.
...
<CardGroup cols={2}>
  <Card title="Patch System" icon="code-merge" href="/development/patches">
    Learn about Cromite's 333 patches to Chromium
  </Card>
