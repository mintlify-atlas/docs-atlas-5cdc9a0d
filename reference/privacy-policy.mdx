...
description: "Detailed breakdown of Cromite's data collection and third-party connections"
icon: 'shield-check'
---
...
Cromite check address "https://github.com/uazo/cromite/releases/download" once a day
</Info>

<Info>
**Download of selected adblock subscription** (enabled by default)

Cromite check user-selected urls in the adblock section once a day. By default, some subscriptions from https://easylist-downloads.adblockplus.org are automatically selected.
</Info>
...
Cromite, by default, downloads from www.cromite.org a zip containing the fonts it uses for anti-fingerpriting protection. If the zip has already been downloaded, no connection is made again. In www.cromite.org, no log is active.
